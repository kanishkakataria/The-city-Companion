...
public class HotelsChennai extends JPanel {
	...
	public HotelsChennai() {
       ...
       setBackground(Color.BLUE);
		...
		SetImageSize(sherton,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/barbequenation.jpg"));
		//add(lalbagh);
		back1.add(sherton);
		...
		SetImageSize(chinatown,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/faruuzi.jpg"));
		//add(lalbagh);
		back1.add(chinatown);
		...
		SetImageSize(bb,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/theflyingelephant.jpg"));
		//add(lalbagh);
		back1.add(bb);
		...
		SetImageSize(np,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/daalchini.jpg"));
		//add(lalbagh);
		...
		textArea_6.setCaretPosition(0);
		 ...
		 JLabel bhagini = new JLabel("");
			...
			SetImageSize(bhagini,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/benjarong.jpg"));
			//add(lalbagh);
			back1.add(bhagini);
