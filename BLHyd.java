...
public class BLHyd extends JPanel {
	...
	public BLHyd() {
       ...
       //scrollPane.setBounds(32, 32, 789,469);
		...
		SetImageSize(elanza,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/lodge-citypark.jpg"));
		//add(lalbagh);
		back1.add(elanza);
		...
		SetImageSize(oberoi,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/lodge-grandelite.jpg"));
		//add(lalbagh);
		back1.add(oberoi);
		...
		SetImageSize(ro,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/lodge-oakwoodresidence.jpg"));
		//add(lalbagh);
		back1.add(ro);
		...
		SetImageSize(ts,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/lodge-lotusgrand.jpg"));
		//add(lalbagh);
		...
		SetImageSize(ll,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/lodge-redfox.jpg"));
		//add(lalbagh);
		back1.add(ll);
		...
		jw.setBounds(800, 550, 200, 150);
			SetImageSize(jw,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/lodge-thegolkonda.jpg"));
			//add(lalbagh);
			back1.add(jw);
