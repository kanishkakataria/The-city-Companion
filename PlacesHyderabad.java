...
//		back1.add(b_l);
		...
		SetImageSize(lalbagh,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Hyderabad/tourism/birlamandir.jpg"));
		//add(lalbagh);
		back1.add(lalbagh);
		...
		SetImageSize(cubbonpark,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/temple-MeccaMasjid.jpg"));
		//add(lalbagh);
		...
		SetImageSize(wonderla,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Hyderabad/tourism/hussainsagar.jpg"));
		//add(lalbagh);
		back1.add(wonderla);
		...
		SetImageSize(ifc,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Golcondafort.jpg"));
		//add(lalbagh);
		...
		SetImageSize(dg,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/SalarjungMuseum.jpeg"));
		//add(lalbagh);
		back1.add(dg);
		...
		textArea_6.setCaretPosition(0);
		 ...
		 JLabel iskcon = new JLabel("");
			...
			SetImageSize(iskcon,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Hyderabad/tourism/charminar.jpg"));
			//add(lalbagh);
			back1.add(iskcon);
