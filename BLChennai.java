...
public class BLChennai extends JPanel {
	...
	public BLChennai() {
       ...
       setBackground(Color.BLUE);
		...
		SetImageSize(elanza,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/gingerhotel.jpg"));
		//add(lalbagh);
		back1.add(elanza);
		...
		SetImageSize(oberoi,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/hyattregencychennai.jpg"));
		//add(lalbagh);
		back1.add(oberoi);
		...
		SetImageSize(ro,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Bangalore/lodging3-leelapalace.jpg"));
		//add(lalbagh);
		back1.add(ro);
		...
		SetImageSize(ts,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/hotelchennaideluxe.jpg"));
		//add(lalbagh);
		...
		SetImageSize(ll,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/lemontreehotel.jpg"));
		//add(lalbagh);
		back1.add(ll);
		...
		jw.setBounds(800, 500, 200, 150);
			SetImageSize(jw,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/radissonblu.jpg"));
			//add(lalbagh);
			back1.add(jw);
