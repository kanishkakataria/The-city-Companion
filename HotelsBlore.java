...
//		back1.add(b_l);
		...
		SetImageSize(sherton,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Bangalore/hotel1-sherton.jpg"));
		//add(lalbagh);
		back1.add(sherton);
		...
		SetImageSize(chinatown,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Bangalore/hotel2-37chinatown.jpg"));
		//add(lalbagh);
		back1.add(chinatown);
		...
		SetImageSize(bb,new ImageIcon("/Users/kanishkamishra/git/SmartCity-Application/SmartCity/img/Bangalore/hotel3-Beijingbites.jpg"));
		//add(lalbagh);
		back1.add(bb);
		...
		SetImageSize(np,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/Bangalore/hotel4-nandinipalace.jpg"));
		//add(lalbagh);
		...
		SetImageSize(ss,new ImageIcon("/Users/kanishkamishra/git/SmartCity-Application/SmartCity/img/Bangalore/hotel4-shantisagar.jpg"));
		//add(lalbagh);
		back1.add(ss);
		...
		textArea_6.setCaretPosition(0);
		 ...
		 JLabel bhagini = new JLabel("");
			...
			SetImageSize(bhagini,new ImageIcon("/Users/kanishkamishra/git/SmartCity-Application/SmartCity/img/Bangalore/hotel6-bhagini.jpg"));
			//add(lalbagh);
			back1.add(bhagini);
