...
public class HotelsMang extends JPanel {
	...
	public HotelsMang() {
       ...
       setBackground(Color.BLUE);
		...
		SetImageSize(sherton,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/chefs.jpeg"));
		//add(lalbagh);
		back1.add(sherton);
		...
		SetImageSize(chinatown,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/haoming.jpeg"));
		//add(lalbagh);
		back1.add(chinatown);
		...
		SetImageSize(bb,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/pallkhi.jpg"));
		//add(lalbagh);
		back1.add(bb);
		...
		SetImageSize(np,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/gajalee.jpeg"));
		//add(lalbagh);
		...
		SetImageSize(ss,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/girimanja.jpeg"));
		//add(lalbagh);
		back1.add(ss);
		...
		textArea_6.setCaretPosition(0);
		 ...
		 JLabel bhagini = new JLabel("");
			...
			SetImageSize(bhagini,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/village.jpeg"));
			//add(lalbagh);
			back1.add(bhagini);
