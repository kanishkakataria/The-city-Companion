...
public class HotelsHyd extends JPanel {
	...
	public HotelsHyd() {
       ...
       setBounds(5, 50, 1440, 920);
		...
		SetImageSize(sherton,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/rest-minerva.jpg"));
		//add(lalbagh);
		back1.add(sherton);
		...
		SetImageSize(chinatown,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/rest-ohris.jpg"));
		//add(lalbagh);
		back1.add(chinatown);
		...
		SetImageSize(bb,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/rest-bawarchi.jpg"));
		//add(lalbagh);
		back1.add(bb);
		...
		SetImageSize(np,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/rest-tabla.jpg"));
		//add(lalbagh);
		...
		SetImageSize(ss,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/rest-paradise.jpg"));
		//add(lalbagh);
		back1.add(ss);
		...
		textArea_6.setCaretPosition(0);
		 ...
		 JLabel bhagini = new JLabel("");
			...
			SetImageSize(bhagini,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/rest-marriott.jpg"));
			//add(lalbagh);
			back1.add(bhagini);
