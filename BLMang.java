...
public class BLMang extends JPanel {
	...
	public BLMang() {
       ...
       setBackground(Color.BLUE);
		...
		SetImageSize(oberoi,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/saffron.jpg"));
		//add(lalbagh);
		back1.add(oberoi);
		...
		SetImageSize(ts,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/gateway.jpg"));
		//add(lalbagh);
		...
		SetImageSize(ll,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/goldfinch.jpg"));
		//add(lalbagh);
		back1.add(ll);
		...
		jw.setBounds(800, 500, 200, 150);
			SetImageSize(jw,new ImageIcon("/Users/kanishkamishra/Desktop/SmartCity-Application/SmartCity/img/oceanpearl.jpg"));
			//add(lalbagh);
			back1.add(jw);
